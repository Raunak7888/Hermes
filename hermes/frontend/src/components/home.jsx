...
const LandingPage = () => {
    ...
    return (
      ...
      `}</style>
                ...
                {/* Hero Section */}
                <main className=" flex items-center justify-center h-screen text-center p-6 md:p-10  pt-32 pb-20 bg-gradient-to-br from-blue-100 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-500">
                    <motion.div
                        initial="hidden"
                        animate="visible"
                    ...
                    >
                        ...
                        >
                            A fast, secure, and user-friendly messaging app
                            designed for the way you live. Talk with friends,
                            share memories, and organize your life—all in one
                            place.
                        </motion.p>
                        <motion.div
                            variants={fadeUp}
